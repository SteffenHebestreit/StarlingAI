"""Reranker sidecar for engram — serves Qwen3-Reranker (or any sentence-transformers
CrossEncoder) in engram's reranker wire format. Vendored from upstream engram
deploy/reranker (github.com/SteffenHebestreit/engram, v0.5.0).
...
relevance) and exposes engram's reranker endpoints.

  RERANKER_API_BASE=http://engram-reranker:8091
