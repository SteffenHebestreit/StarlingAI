...
- ${delegateOnly ? "In this mode, routine direct execution is disabled. Use delegate_to_agent for work, but memory_store, memory_search, assistant_personality_view, and assistant_personality_update remain available directly for durable memory and self-profile management." : orchestrationOnly ? "In this mode, routine direct execution tools are unavailable. Use orchestration tools for work, but memory_store, memory_search, assistant_personality_view, and assistant_personality_update remain available directly for durable memory and self-profile management." : "In this mode, prefer direct tools for repository inspection, workspace memory, web access, browser steps, multimodal helpers, credential-safe login flows, and self-profile management before delegating."}
