...
export function createGateway() {
  ...
  // ── Document RAG management (list / upload / view / remove) ────────────────
  // Manage files ingested into the engram document library across the three
  // scopes (session / user / workspace). Removing a document updates the RAG
  // (engram delete) AND deletes the persisted original file.
