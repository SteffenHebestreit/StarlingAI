...
| `agents` | packages/core/src/config/schema.ts:1571 | 131 |
...
| `autonomousModeAntiRefusal` | packages/core/src/config/schemas/orchestration.ts:62 | 1 |
...
| `budget` | packages/core/src/config/schema.ts:1507 | 76 |
...
| `citationHonestyGuard` | packages/core/src/config/schemas/orchestration.ts:104 | 2 |
| `citationTurnScopedResearch` | packages/core/src/config/schemas/orchestration.ts:274 | 1 |
| `clamdHost` | packages/core/src/config/schema.ts:458 | 2 |
| `clamdPort` | packages/core/src/config/schema.ts:459 | 2 |
| `clampSubAgentTimeoutToParent` | packages/core/src/config/schemas/orchestration.ts:480 | 4 |
...
| `container` | packages/core/src/config/schema.ts:678 | 66 |
...
| `crossAgentArtifactReuse` | packages/core/src/config/schemas/orchestration.ts:449 | 2 |
...
| `defaults` | packages/core/src/config/schema.ts:1572 | 69 |
...
| `discovery` | packages/core/src/config/schema.ts:586 | 30 |
| `discoveryPrefetch` | packages/core/src/config/schemas/orchestration.ts:555 | 3 |
| `displayName` | packages/core/src/config/schema.ts:342 | 14 |
| `distillSharedFacts` | packages/core/src/config/schemas/orchestration.ts:634 | 1 |
| `distillSharedFactsMaxPerRun` | packages/core/src/config/schemas/orchestration.ts:644 | 1 |
...
| `durableApprovals` | packages/core/src/config/schemas/orchestration.ts:695 | 2 |
...
| `evidence` | packages/core/src/config/schema.ts:1534 | 83 |
...
| `excludeDelegationWaitFromTurnBudget` | packages/core/src/config/schemas/orchestration.ts:491 | 3 |
...
| `forceToolChoiceWhenOrchestrationRequired` | packages/core/src/config/schemas/orchestration.ts:661 | 1 |
| `freshnessHonestyGuard` | packages/core/src/config/schemas/orchestration.ts:94 | 1 |
...
| `honestSynthesisOnPartialEvidence` | packages/core/src/config/schemas/orchestration.ts:544 | 1 |
...
| `inlineArtifactFabricationGuard` | packages/core/src/config/schemas/orchestration.ts:192 | 1 |
...
| `language` | packages/core/src/config/schemas/multimodal.ts:73 | 53 |
...
| `maxEffortTurnOversight` | packages/core/src/config/schemas/orchestration.ts:504 | 2 |
...
| `midTurnSteering` | packages/core/src/config/schemas/orchestration.ts:675 | 1 |
...
| `model` | packages/core/src/config/schema.ts:1137 | 185 |
...
| `models` | packages/core/src/config/schema.ts:504 | 45 |
...
| `name` | packages/core/src/config/schema.ts:1794 | 283 |
...
| `notes` | packages/core/src/config/schema.ts:776 | 40 |
...
| `perTurnCaps` | packages/core/src/config/schemas/orchestration.ts:706 | 5 |
| `phoneNumberId` | packages/core/src/config/schemas/channels.ts:53 | 6 |
| `planApproval` | packages/core/src/config/schemas/orchestration.ts:679 | 1 |
...
| `progressVerifierSemantic` | packages/core/src/config/schemas/orchestration.ts:612 | 2 |
...
| `qaDeliveryLoopEscalateToCoordinator` | packages/core/src/config/schemas/orchestration.ts:315 | 1 |
...
| `reasoningEffort` | packages/core/src/config/schema.ts:199 | 8 |
...
| `relaySingleDeliverable` | packages/core/src/config/schemas/orchestration.ts:669 | 1 |
...
| `resumePartialOnCorrectiveBuild` | packages/core/src/config/schemas/orchestration.ts:388 | 1 |
...
| `reuseSessionEvidenceOnRefinement` | packages/core/src/config/schemas/orchestration.ts:528 | 1 |
| `riskGatedQA` | packages/core/src/config/schemas/effort.ts:47 | 7 |
| `role` | packages/core/src/config/schema.ts:821 | 91 |
| `rolesClaim` | packages/core/src/config/schema.ts:380 | 1 |
| `routing` | packages/core/src/config/schema.ts:227 | 69 |
| `sampleRate` | packages/core/src/config/schema.ts:537 | 2 |
| `sandboxShellExec` | packages/core/src/config/schema.ts:1124 | 2 |
| `scene` | packages/core/src/config/schema.ts:1213 | 69 |
...
| `semanticUngroundedFactualGuard` | packages/core/src/config/schemas/orchestration.ts:151 | 1 |
...
| `steps` | packages/core/src/config/schema.ts:1256 | 42 |
...
| `subAgentToolCaps` | packages/core/src/config/schemas/orchestration.ts:699 | 4 |
...
| `toolName` | packages/core/src/config/schemas/multimodal.ts:17 | 67 |
