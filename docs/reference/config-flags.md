...
| `args` | packages/core/src/config/schema.ts:659 | 138 |
...
| `clampSubAgentTimeoutToParent` | packages/core/src/config/schemas/orchestration.ts:472 | 4 |
...
| `command` | packages/core/src/config/schema.ts:658 | 40 |
...
| `discoveryPrefetch` | packages/core/src/config/schemas/orchestration.ts:547 | 3 |
| `displayName` | packages/core/src/config/schema.ts:342 | 14 |
| `distillSharedFacts` | packages/core/src/config/schemas/orchestration.ts:626 | 1 |
| `distillSharedFactsMaxPerRun` | packages/core/src/config/schemas/orchestration.ts:636 | 1 |
| `distillSharedFactsMinChars` | packages/core/src/config/schemas/orchestration.ts:631 | 1 |
| `distributedCancel` | packages/core/src/config/schema.ts:1543 | 2 |
| `dmPolicy` | packages/core/src/config/schemas/channels.ts:18 | 5 |
| `domain` | packages/core/src/config/schema.ts:820 | 31 |
| `durableApprovals` | packages/core/src/config/schemas/orchestration.ts:687 | 2 |
...
| `evidence` | packages/core/src/config/schema.ts:1534 | 79 |
...
| `forceToolChoiceWhenOrchestrationRequired` | packages/core/src/config/schemas/orchestration.ts:653 | 1 |
...
| `honestSynthesisOnPartialEvidence` | packages/core/src/config/schemas/orchestration.ts:536 | 1 |
| `host` | packages/core/src/config/schema.ts:693 | 94 |
| `http` | packages/core/src/config/schema.ts:738 | 72 |
| `humanInLoopSteps` | packages/core/src/config/schema.ts:1191 | 20 |
| `id` | packages/core/src/config/schema.ts:547 | 218 |
| `ignoreCase` | packages/core/src/config/schema.ts:1238 | 2 |
| `image` | packages/core/src/config/schema.ts:666 | 51 |
...
| `isolation` | packages/core/src/config/schema.ts:1802 | 18 |
...
| `maxEffortTurnOversight` | packages/core/src/config/schemas/orchestration.ts:496 | 2 |
...
| `maxIterations` | packages/core/src/config/schema.ts:825 | 20 |
...
| `method` | packages/core/src/config/schema.ts:926 | 78 |
| `midTurnSteering` | packages/core/src/config/schemas/orchestration.ts:667 | 1 |
...
| `model` | packages/core/src/config/schema.ts:1137 | 174 |
...
| `perTurnCaps` | packages/core/src/config/schemas/orchestration.ts:698 | 5 |
| `phoneNumberId` | packages/core/src/config/schemas/channels.ts:53 | 6 |
| `planApproval` | packages/core/src/config/schemas/orchestration.ts:671 | 1 |
...
| `progressVerifierSemantic` | packages/core/src/config/schemas/orchestration.ts:604 | 2 |
...
| `quorumEarlySynthesis` | packages/core/src/config/schemas/orchestration.ts:565 | 2 |
| `quorumFraction` | packages/core/src/config/schemas/orchestration.ts:568 | 1 |
| `quorumStragglerGraceMs` | packages/core/src/config/schemas/orchestration.ts:571 | 1 |
...
| `relaySingleDeliverable` | packages/core/src/config/schemas/orchestration.ts:661 | 1 |
...
| `scene` | packages/core/src/config/schema.ts:1213 | 65 |
...
| `secret` | packages/core/src/config/schema.ts:886 | 48 |
...
| `subAgentSynthesisReserveMs` | packages/core/src/config/schemas/orchestration.ts:595 | 2 |
| `subAgentToolCaps` | packages/core/src/config/schemas/orchestration.ts:691 | 4 |
...
| `task` | packages/core/src/config/schema.ts:1187 | 118 |
| `taskConditionalPrompt` | packages/core/src/config/schema.ts:1676 | 1 |
| `taskGraphFailureDisposition` | packages/core/src/config/schemas/orchestration.ts:452 | 1 |
...
| `token` | packages/core/src/config/schema.ts:1049 | 153 |
...
| `toolName` | packages/core/src/config/schemas/multimodal.ts:17 | 64 |
| `toolRerankMinTools` | packages/core/src/config/schemas/orchestration.ts:585 | 2 |
| `tools` | packages/core/src/config/schema.ts:824 | 165 |
...
| `triggers` | packages/core/src/config/schema.ts:1257 | 31 |
...
| `userProfilePrefetch` | packages/core/src/config/schemas/orchestration.ts:558 | 3 |
