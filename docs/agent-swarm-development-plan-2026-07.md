...
**Status:** R0–R3 implemented at slice-1 depth and adversarially reviewed (see "Implementation record"); paused at the operational checkpoint — R4/R5 and enforcement rollouts require a commit, image rebuild, and shadow-telemetry soak first
